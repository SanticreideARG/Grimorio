...
export const cap1 = {
  ...
  nodes: [
    ...
    { id: 'c1n02', type: 'combat', name: 'Sendero Calcinado', pos: { x: 36.46, y: 23.70 }, enemies: ['esbirro', 'esbirro', 'esbirro'] },
    { id: 'c1n03', type: 'event', name: 'La Encrucijada', pos: { x: 60.83, y: 30.56 }, eventPool: 'eventos' },
    { id: 'c1n04', type: 'combat', name: 'Campos de Ceniza', pos: { x: 86.56, y: 25.93 }, enemies: ['esbirro', 'enjambre', 'enjambre'] },
    ...
    { id: 'c1n07', type: 'combat', name: 'La Aldea Quemada', pos: { x: 38.65, y: 46.30 }, enemies: ['lanzador', 'esbirro', 'esbirro', 'esbirro'] },
    { id: 'c1n08', type: 'elite', name: 'El Carroñero Alfa', pos: { x: 14.17, y: 52.41 }, enemies: ['carronero_alfa', 'esbirro', 'esbirro'] },
    { id: 'c1n09', type: 'event', name: 'El Pozo Seco', pos: { x: 13.65, y: 70.37 }, eventPool: 'eventos' },
    { id: 'c1n10', type: 'combat', name: 'Emboscada en la Niebla', pos: { x: 37.50, y: 67.78 }, enemies: ['acechador', 'invocador', 'esbirro'] },
    { id: 'c1n11', type: 'rest', name: 'Claro del Viajero', pos: { x: 62.08, y: 72.41 } },
    { id: 'c1n12', type: 'elite', name: 'El Caballero Caído', pos: { x: 86.46, y: 67.96 }, enemies: ['caballero_caido', 'esbirro', 'esbirro'] },
    ...
    { id: 'c1n16', type: 'boss', name: 'GULRATH, el Devorador', pos: { x: 13.02, y: 88.70 }, enemies: ['gulrath', 'esbirro', 'esbirro'] },
  ],
};
