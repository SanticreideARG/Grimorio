...
export const cap2 = {
  ...
  nodes: [
    ...
    { id: 'c2n03', type: 'event',  name: 'El Capullo Susurrante',   pos: { x: 50, y: 17 }, eventPool: 'eventos' },
    ...
    { id: 'c2n09', type: 'event',  name: 'El Nido Abandonado',      pos: { x: 31, y: 37 }, eventPool: 'eventos' },
    ...
    { id: 'c2n13', type: 'event',  name: 'La Ofrenda de Seda',      pos: { x: 50, y: 58 }, eventPool: 'eventos' },
    ...
    { id: 'c2n17', type: 'event',  name: 'El Umbral de Seda',       pos: { x: 50, y: 80 }, eventPool: 'eventos' },
