...
export const cap3 = {
  ...
  nodes: [
    ...
    { id: 'c3n03', type: 'event',  name: 'El Brasero Eterno',       pos: { x: 50, y: 15 }, eventPool: 'eventos' },
    ...
    { id: 'c3n09', type: 'event',  name: 'La Cripta Abierta',       pos: { x: 31, y: 37 }, eventPool: 'eventos' },
    ...
    { id: 'c3n13', type: 'event',  name: 'El Pacto de Ceniza',      pos: { x: 50, y: 59 }, eventPool: 'eventos' },
    ...
    { id: 'c3n18', type: 'event',  name: 'El Espejo de Hollín',     pos: { x: 50, y: 82 }, eventPool: 'eventos' },
